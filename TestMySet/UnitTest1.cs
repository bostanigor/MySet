...
namespace TestMySet
{
    public class Tests
    {
        ...
        {
            var set1 = new MySet.MySet(new MyRange(1, 5));
            Assert.AreEqual(set1.ToArray(), new int[] {1, 2, 3, 4, 5});
            var set2 = new MySet.MySet();
            Assert.AreEqual(set2.ToArray(), new int[] {});
            var set3 = new MySet.MySet(new MyRange(1, 3), new MyRange(5, 6));
            Assert.AreEqual(set3.ToArray(), new int[] {1, 2, 3, 5, 6});
            var set4 = new MySet.MySet(new MyRange(1, 1));
        ...
        {
            var set1 = new MySet.MySet(new MyRange(1, 4), new MyRange(3, 5));
            Assert.AreEqual(set1.ToArray(), new int[] {1, 2, 3, 4, 5});
            var set2 = new MySet.MySet(new MyRange(1, 4), new MyRange(1, 4));
            Assert.AreEqual(set2.ToArray(), new int[] {1, 2, 3, 4});
            var set3 = new MySet.MySet(new MyRange(3, 5), new MyRange(1, 4));
            Assert.AreEqual(set3.ToArray(), new int[] {1, 2, 3, 4, 5});
            var set4 = new MySet.MySet(new MyRange(1, 4), new MyRange(5, 6));
            Assert.AreEqual(set4.ToArray(), new int[] {1, 2, 3, 4, 5, 6});
            var set5 = new MySet.MySet(new MyRange(1, 3), new MyRange(2, 3));
            Assert.AreEqual(set5.ToArray(), new int[] {1, 2, 3});
            var set6 = new MySet.MySet(new MyRange(1, 3), new MyRange(2, 5), new MyRange(3, 6));
        ...
        {
            var set1 = new MySet.MySet(new MyRange(1, 4));
            ...
            var set3 = new MySet.MySet(new MyRange(1, 3), new MyRange(2, 4), new MyRange(6, 6));
        ...
        {
            var set1 = 
                new MySet.MySet(new MyRange(1, 3)).Union(
                new MySet.MySet(new MyRange(4, 6)));
            ...
            var set3 = 
                new MySet.MySet(new MyRange(4, 5)).Union(
                new MySet.MySet(new MyRange(1, 2)));
            Assert.AreEqual(set3.ToArray(), new int[] {1, 2, 4, 5});
            var set4 = 
                new MySet.MySet(new MyRange(1, 3)).Union(
                new MySet.MySet(new MyRange(2, 4)));
            Assert.AreEqual(set4.ToArray(), new int[] {1, 2, 3, 4});
            var set5 = 
                new MySet.MySet(new MyRange(1, 3)).Union(
                new MySet.MySet(new MyRange(2, 4), new MyRange(6, 7)));
            Assert.AreEqual(set5.ToArray(), new int[] {1, 2, 3, 4, 6, 7});
            var set6 = 
                new MySet.MySet(new MyRange(1, 1), new MyRange(3, 4), new MyRange(5, 6)).Union(
                new MySet.MySet(new MyRange(0, 7)));
        ...
        {
            var set1 = 
                new MySet.MySet(new MyRange(1, 3)).Intersection(
                new MySet.MySet(new MyRange(4, 6)));
            ...
            Assert.AreEqual(set2.ToArray(), new int[] {});
            var set3 = 
                new MySet.MySet(new MyRange(1, 5)).Intersection(
                new MySet.MySet(new MyRange(4, 6)));
            Assert.AreEqual(set3.ToArray(), new int[] {4, 5});
            var set4 = 
                new MySet.MySet(new MyRange(1, 3)).Intersection(
                new MySet.MySet(new MyRange(3, 7)));
            Assert.AreEqual(set4.ToArray(), new int[] {3});
            var set5 = 
                new MySet.MySet(new MyRange(1, 4), new MyRange(6, 9)).Intersection(
                new MySet.MySet(new MyRange(3, 7)));
        ...
        {
            var set1 = 
                new MySet.MySet(new MyRange(1, 3), new MyRange(5, 5)).Difference(
                new MySet.MySet());
            Assert.AreEqual(set1.ToArray(), new int[] {1, 2, 3, 5});
            var set2 = 
                new MySet.MySet().Difference(
                new MySet.MySet(new MyRange(1, 3), new MyRange(5, 5)));
            Assert.AreEqual(set2.ToArray(), new int[] {});
            var set3 = 
                new MySet.MySet(new MyRange(1, 5)).Difference(
                new MySet.MySet(new MyRange(6, 8)));
            Assert.AreEqual(set3.ToArray(), new int[] {1, 2, 3, 4, 5});
            var set4 = 
                new MySet.MySet(new MyRange(5, 7)).Difference(
                new MySet.MySet(new MyRange(0, 3)));
            ...
            var set6 = 
                new MySet.MySet(new MyRange(1, 4), new MyRange(6, 8)).Difference(
                new MySet.MySet(new MyRange(3, 7)));
            Assert.AreEqual(set6.ToArray(), new int[] {1, 2, 8});
            var set7 = 
                new MySet.MySet(new MyRange(1, 5)).Difference(
                new MySet.MySet(new MyRange(3, 3)));
